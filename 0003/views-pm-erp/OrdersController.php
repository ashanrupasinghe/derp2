...
class OrdersController extends AppController {
	...
	public function index() {
		$orders = $this->paginate ( $this->Orders,['contain'=>'customers','order' => ['Orders.deliveryDate' => 'DESC','Orders.deliveryTime' => 'DESC'],'conditions'=>['deleted ='=>0]] );
		/* print '<pre>';
		print_r($orders);
		die(); */
...
public function schedule() {
	$orders = $this->paginate ( $this->Orders,['contain'=>'customers','conditions'=>['Orders.status IN'=>[1,2,3,4,7],'deleted ='=>0],'order' => ['Orders.deliveryDate' => 'DESC','Orders.deliveryTime' => 'DESC']] );
	/* print '<pre>';
		print_r($orders);
	die(); */
	$callcenter_query=$this->Orders->Callcenter->find('list',['keyField'=>'id','valueField'=>'users.username'])->select(['id','users.username'])
