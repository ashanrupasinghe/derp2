...
<div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <tr>
                ...
                <td>
				<?php if(sizeof($deliveryNotification['order']['customer'])>0){?>
				
				<?= h($deliveryNotification['order']['customer']->firstName. ' '.$deliveryNotification['order']['customer']->lastName ) ?>
				<?php }elseif(sizeof($deliveryNotification['order']['shipping'])>0){
						echo $deliveryNotification['order']['shipping']->guest_name;
				 ...
				 <?= h($deliveryNotification['order']['customer']->address ) ?></td>
                <?php }else{
					echo $deliveryNotification['order']->address;
				}?>
                <td class="actions">
