...
<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><?= __('Update Order') ?> <small><?= __('Order ID: '.$order->id) ?></small></h2>
    ...
    <table class="table table-hover">
        ...
        <tr>
			...
			<?php }elseif(sizeof($order->shipping)>0 && $order->shipping->guest_name!=null ){
  ...
  <!--      <tr>
	...
	<div class="orders col-lg-4 col-md-4 col-sm-12 columns content div-top-pad-0 div-left-pad-0">
		...
		<tr>
            ...
            <td>
            <?php echo $this->Form->input('payment_method',['label' => false,'class'=>'form-control','options'=>$pm,'empty'=>'select method','default'=>$order->payment_method]); ?>            
            </td>
        </tr>
		</table>
		</div>
