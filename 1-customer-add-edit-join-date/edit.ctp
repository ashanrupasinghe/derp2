...
<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <input class="form-control" type="text" value="<?= $customer->created!=null ? date('d F Y - H:i', strtotime($customer->created)):date('d F Y - H:i') ?>" readonly>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
					<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                </div>
				<input type="hidden" id="dtp_input2" value="<?= $customer->created!=null ? date('yyyy-mm-dd H:i', strtotime($customer->created)):date('yyyy-mm-dd H:i') ?>" name="created" />
                        </div>
                      </div>
