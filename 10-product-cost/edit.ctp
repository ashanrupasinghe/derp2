...
<?= $this->Form->create($product,['class'=>'form-horizontal form-label-left']) ?>
					  ...
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="price">Cost</label>                        
						<div class="col-md-6 col-sm-6 col-xs-12">                          
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <?php echo $this->Form->input('supplierId',['label' => false,'empty'=>'select supplier','options'=>$suppliers,'multiple'=>'multiple','class'=>'form-control col-md-7 col-xs-12','default'=>$current_suppliers]);?>
