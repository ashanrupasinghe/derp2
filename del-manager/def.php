        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?php echo $userLevel==1 ? $this->Url->build('/summary'):$this->Url->build('/customers/search'); ?>" class="site_title">
              ...
              <div class="menu_section">
                ...
                <?php   }else{ ?> 
				 ...
				 <?php elseif($userLevel==6):?>
						<a href="<?php echo $this->Url->build('/orders/schedule'); ?>"><i class="fa fa-bicycle"></i>Order Schedule</a>
                 <?php else:?>
