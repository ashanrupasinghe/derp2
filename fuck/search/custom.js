        ...
        if (jQuery('#checkout-step-billing').is(":visible")) {
            ...
            jQuery.ajax({
                ...
                success: function (response) {
                    ...
                    jQuery("div#err_3").append("<p style='color:green;'>Your order has been placed successfully. You will receive an order confirmation mail shortly. Please contact us on 0117 556600 for any queries. </p>");
